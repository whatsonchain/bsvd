...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/whatsonchain/bsvd/peer)
...
```bash
$ go get -u github.com/whatsonchain/bsvd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/whatsonchain/bsvd/peer#example-package--NewOutboundPeer)  
