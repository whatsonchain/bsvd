...
* Unlike bitcoind that has the wallet and chain intermingled in the same process
  ...
  [bsvwallet](https://github.com/whatsonchain/bsvwallet).
...
[rpcclient](https://github.com/whatsonchain/bsvd/rpcclient) package.
...
[rpcclient](https://github.com/whatsonchain/bsvd/rpcclient) package to connect with
